...
const Laptop = ({ laptop }) => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center gap-4 p-5 bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300"
    >
      <motion.img
        src={product_image}
        alt={product_title}
      ...
      <div className="flex flex-col items-center text-center mt-2 gap-3">
        ...
        >
          <Link
            ...
            className="px-5 py-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-full font-medium shadow hover:from-blue-600 hover:to-indigo-600 transition-all duration-300"
